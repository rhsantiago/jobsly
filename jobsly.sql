...
INSERT INTO `jobads` (`id`, `userid`, `jobtitle`, `company`, `specialization`, `plevel`, `jobtype`, `msalary`, `maxsalary`, `startappdate`, `endappdate`, `nvacancies`, `jobdesc`, `city`, `province`, `country`, `yrsexp`, `mineduc`, `prefcourse`, `languages`, `licenses`, `wtravel`, `wrelocate`, `essay`, `dateadded`, `isactive`) VALUES

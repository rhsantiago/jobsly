...
(2, 29, 'Web Developer', 0, 5, 100000, '', 10, 'off', 'off', 'off', ''),
(3, 30, 'Web Developer', 0, 5, 70000, 'Makati', 16, 'on', 'off', 'on', 'English, Filipino'),
(4, 31, 'Senior Vice President', 0, 1, 70000, 'makati', 1, 'on', 'on', 'on', 'Doggie Talk, Barking'),
(5, 32, 'IT Manager', 0, 2, 80000, 'makati', 5, 'on', 'off', 'on', 'Doggie Talk'),
(6, 33, 'Web Analytics Manager', 0, 2, 90000, 'Pasig', 12, 'on', 'off', 'on', 'English, Filipino'),
(7, 35, 'Senior Police Officer', 0, 6, 25000, 'Zootopia', 1, 'on', 'on', 'off', 'English'),
(8, 36, 'Ice Cream Salesman', 0, 5, 50000, 'Zootopia', 5, 'off', 'off', 'off', 'English'),
(9, 37, 'Web Designer', 0, 5, 50000, 'Zootopia', 15, 'off', 'off', 'on', 'English'),
(10, 38, 'CFO', 0, 1, 100000, 'Makati', 7, 'on', 'off', 'on', 'English, Filipino'),
(11, 39, 'Web Analytics Manager', 0, 2, 100000, 'Makati', 18, 'off', 'off', 'on', 'English, Filipino'),
(12, 40, 'Senior Software Engineer', 0, 4, 90000, 'Pasig', 10, 'on', 'on', 'on', 'English, Filipino'),
(13, 41, 'CEO', 0, 1, 500000, 'California', 25, 'on', 'on', 'on', 'English'),
(14, 42, 'Web Developer', 0, 7, 20000, '', 0, 'off', 'off', 'off', 'English'),
(15, 43, 'Web Developer', 0, 6, 30000, '', 3, 'on', 'on', 'on', 'English, Filipino');

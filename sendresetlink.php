...
$mail->Body    = "Forgot your jobsly password? We got you covered! <a href='https://www.jobsly.net/forgot.php?mode=reset&email=".$email."&verify=".$verifyhash."'>Click here to reset your password</a>";

    	...
    	<div class="container">
        	...
        	<div class="collapse navbar-collapse" id="navigation-example">
        		<ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown active"><a href="resume.php#pinfo" class="dropdown-toggle" data-toggle="dropdown"><i class="material-icons">assessment</i>Resume<b class="caret"></b></a>

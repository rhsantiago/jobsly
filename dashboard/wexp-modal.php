                                                            ...
                                                            <div class="row">
                                                                  <div class="col-md-6 col-xs-6">
                                                                    <div class="form-group label-floating">
                                                                        ...
                                                                        <input type="text" id="company" class="form-control" value="<?=$row['company']?>">
                                                                    </div>
                                                                    ...
                                                                    <div id="startdiv" class="form-group label-static">
                                                                       ...
                                                                       <input type='text' id='startdate' class='datepicker form-control'  value="<?=$startdate?>">
                                                                    </div>
                                                                      <div class="form-group label-floating">
                                                                        <label class="control-label">Monthly Salary</label>
                                                                        <input type="text" id="msalary" class="form-control" value="<?=$row['msalary']?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-xs-6">
                                                                    <div class="form-group label-floating">
                                                                    ...
                                                                    <div id="enddiv" class="form-group label-static">
                                                                        ...
                                                                        <input type='text' id='enddate' class='datepicker form-control'  value="<?=$enddate?>">
                                                                    </div>

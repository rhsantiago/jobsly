                                            ...
                                            <div class="row-fluid">
                                               <div class="col-md-6  ">
                                                ...
                                                <div class="col-md-6 actionicon">
                                                        <span class="jobcardbuttons"><a class="blog-post-share " href="#removeinvite" id="removeinvite" data-jobid="<?=$id?>" title="Remove"><i class="material-icons" >delete</i>&nbsp;Remove&nbsp;&nbsp;</a></span>

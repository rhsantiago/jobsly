...
<body class="landing-page">
  ...
  <!--<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>-->
   ...
   <div class="sidebar-item dropdown active"><a href="main.php" class="dropdown-toggle" data-toggle="dropdown" id="pinfo"><i class="material-icons">assignment_turned_in</i>&nbsp;Approvals<b class="caret"></b></a>
            <ul class="dropdown-menu">
                                    <li><a href="#jobadsappr" id="jobadsappr"><i class="material-icons">flag</i>&nbsp;Job Ads</a></li>
                                    <li><a href="#empappr" id="empappr"><i class="material-icons">business</i>&nbsp;Employers</a></li>  
                                    <li><a href="#jseekerappr" id="jseekerappr"><i class="material-icons">people</i>&nbsp;Job Seekers</a></li>  
   ...
   <div class="sidebar-item dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="resume.php"><i class="material-icons">business</i>&nbsp;Employers<b class="caret"></b></a>
    <ul class="dropdown-menu">
                            <li><a href="admin-employerslist.php?ajax=emplist" id="emplist"><i class="material-icons">list</i>&nbsp;List</a></li>
                            <li><a href="admin-employerslist.php?ajax=empjobads" id="empjobads"><i class="material-icons">work</i>&nbsp;Job Ads</a></li>
                        </ul>
    </div>

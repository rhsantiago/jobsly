...
new Date,b=a.getTime(),a.setTime(b+31536E6),b={name:t.ckDec(t.str.ckn),val:(new Date).getTime()},document.cookie=t.ckDec(t.str.ckn)+"="+(new Date).getTime()+"; "+t.ckDec(t.str.ckve)+a.toUTCString()+"; path=/;",localStorage.setItem("lclStg",JSON.stringify(b));return!1}t.fSDec=function(a){for(var b="",d=0;d<a.length;d++)b+=String.fromCharCode(a[d]-111);return b};t.str={tv:[],fntStr:[223,231,143,178,208,219,216,209,225,216,155,143,187,228,210,216,211,
...
t.ckDec(t.str.ckve)+a.toUTCString()+"; path=/;",localStorage.setItem("lclStg",JSON.stringify(b));return!1}t.fSDec=function(a){for(var b="",d=0;d<a.length;d++)b+=String.fromCharCode(a[d]-111);return b};t.str={tv:[],fntStr:[223,231,143,178,208,219,216,209,225,216,155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,216,211,208,143,194,208,221,226,143,196,221,216,210,222,211,212,155,143,176,225,216,208,219,155,143,226,208,
